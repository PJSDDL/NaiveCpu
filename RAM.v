...
/* Module Version: 7.5 */
/* E:\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n RAM -lang verilog -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 10 -rp 1000 -addr_width 8 -data_width 8 -num_rows 256 -cascade -1 -mem_init0 -writemode NORMAL  */
...
module RAM (Clock, ClockEn, Reset, WE, Address, Data, Q)/* synthesis NGD_DRC_MASK=1 */;
    ...
    DP8KC RAM_0_0_0 (.DIA8(scuba_vlo), .DIA7(Data[7]), .DIA6(Data[6]), .DIA5(Data[5]), 
        .DIA4(Data[4]), .DIA3(Data[3]), .DIA2(Data[2]), .DIA1(Data[1]), 
        .DIA0(Data[0]), .ADA12(scuba_vlo), .ADA11(scuba_vlo), .ADA10(Address[7]), 
        ...
        .CSB1(scuba_vlo), .CSB0(scuba_vlo), .RSTB(scuba_vlo), .DOA8(), .DOA7(Q[7]), 
    ...
    // exemplar begin
    // exemplar attribute RAM_0_0_0 MEM_LPC_FILE RAM.lpc
    // exemplar attribute RAM_0_0_0 MEM_INIT_FILE INIT_ALL_0s
    // exemplar end
